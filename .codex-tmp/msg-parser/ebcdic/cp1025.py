"""
Python Character Mapping Codec cp1025 generated from 'temp/cp1025.txt' with gencodec.py.
"""
...
decoding_table = (
    ...
    '\u0453'    # 0x43 -> CYRILLIC SMALL LETTER GJE
    ...
    '-'         # 0x60 -> HYPHEN-MINUS
    '/'         # 0x61 -> SOLIDUS
    '\u0403'    # 0x62 -> CYRILLIC CAPITAL LETTER GJE
