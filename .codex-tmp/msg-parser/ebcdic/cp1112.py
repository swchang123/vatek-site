"""
Python Character Mapping Codec cp1112 generated from 'temp/cp1112.txt' with gencodec.py.
"""
...
decoding_table = (
    ...
    '\u0161'    # 0x42 -> LATIN SMALL LETTER S WITH CARON
    '\xe4'      # 0x43 -> LATIN SMALL LETTER A WITH DIAERESIS
    '\u0105'    # 0x44 -> LATIN SMALL LETTER A WITH OGONEK
    '\u012f'    # 0x45 -> LATIN SMALL LETTER I WITH OGONEK
    '\u016b'    # 0x46 -> LATIN SMALL LETTER U WITH MACRON
    '\xe5'      # 0x47 -> LATIN SMALL LETTER A WITH RING ABOVE
    '\u0113'    # 0x48 -> LATIN SMALL LETTER E WITH MACRON
    '\u017e'    # 0x49 -> LATIN SMALL LETTER Z WITH CARON
    '\xa2'      # 0x4A -> CENT SIGN
    '.'         # 0x4B -> FULL STOP
    '<'         # 0x4C -> LESS-THAN SIGN
    ...
    '\u0117'    # 0x53 -> LATIN SMALL LETTER E WITH DOT ABOVE
    '\u010d'    # 0x54 -> LATIN SMALL LETTER C WITH CARON
    '\u0173'    # 0x55 -> LATIN SMALL LETTER U WITH OGONEK
    '\u201e'    # 0x56 -> DOUBLE LOW-9 QUOTATION MARK
    '\u201c'    # 0x57 -> LEFT DOUBLE QUOTATION MARK
    '\u0123'    # 0x58 -> LATIN SMALL LETTER G WITH CEDILLA
    ...
    '-'         # 0x60 -> HYPHEN-MINUS
    '/'         # 0x61 -> SOLIDUS
    '\u0160'    # 0x62 -> LATIN CAPITAL LETTER S WITH CARON
    '\xc4'      # 0x63 -> LATIN CAPITAL LETTER A WITH DIAERESIS
    '\u0104'    # 0x64 -> LATIN CAPITAL LETTER A WITH OGONEK
    '\u012e'    # 0x65 -> LATIN CAPITAL LETTER I WITH OGONEK
    '\u016a'    # 0x66 -> LATIN CAPITAL LETTER U WITH MACRON
    '\xc5'      # 0x67 -> LATIN CAPITAL LETTER A WITH RING ABOVE
    '\u0112'    # 0x68 -> LATIN CAPITAL LETTER E WITH MACRON
    '\u017d'    # 0x69 -> LATIN CAPITAL LETTER Z WITH CARON
    '\xa6'      # 0x6A -> BROKEN BAR
    ','         # 0x6B -> COMMA
    '%'         # 0x6C -> PERCENT SIGN
    '_'         # 0x6D -> LOW LINE
    ...
    '\u0116'    # 0x73 -> LATIN CAPITAL LETTER E WITH DOT ABOVE
    '\u010c'    # 0x74 -> LATIN CAPITAL LETTER C WITH CARON
    '\u0172'    # 0x75 -> LATIN CAPITAL LETTER U WITH OGONEK
    '\u012a'    # 0x76 -> LATIN CAPITAL LETTER I WITH MACRON
    '\u013b'    # 0x77 -> LATIN CAPITAL LETTER L WITH CEDILLA
    '\u0122'    # 0x78 -> LATIN CAPITAL LETTER G WITH CEDILLA
    '`'         # 0x79 -> GRAVE ACCENT
    ':'         # 0x7A -> COLON
    '#'         # 0x7B -> NUMBER SIGN
    '@'         # 0x7C -> COMMERCIAL AT
    ...
    '\u0101'    # 0x8C -> LATIN SMALL LETTER A WITH MACRON
    '\u017c'    # 0x8D -> LATIN SMALL LETTER Z WITH DOT ABOVE
    '\u0144'    # 0x8E -> LATIN SMALL LETTER N WITH ACUTE
    ...
    '\u0156'    # 0x9A -> LATIN CAPITAL LETTER R WITH CEDILLA
    '\u0157'    # 0x9B -> LATIN SMALL LETTER R WITH CEDILLA
    '\xe6'      # 0x9C -> LATIN SMALL LETTER AE
    '\u0137'    # 0x9D -> LATIN SMALL LETTER K WITH CEDILLA
    ...
    '\u201d'    # 0xAA -> RIGHT DOUBLE QUOTATION MARK
    '\u017a'    # 0xAB -> LATIN SMALL LETTER Z WITH ACUTE
    '\u0100'    # 0xAC -> LATIN CAPITAL LETTER A WITH MACRON
    '\u017b'    # 0xAD -> LATIN CAPITAL LETTER Z WITH DOT ABOVE
    '\u0143'    # 0xAE -> LATIN CAPITAL LETTER N WITH ACUTE
    '\xae'      # 0xAF -> REGISTERED SIGN
    '^'         # 0xB0 -> CIRCUMFLEX ACCENT
    '\xa3'      # 0xB1 -> POUND SIGN
    '\u012b'    # 0xB2 -> LATIN SMALL LETTER I WITH MACRON
    '\xb7'      # 0xB3 -> MIDDLE DOT
    ...
    '\u0179'    # 0xBC -> LATIN CAPITAL LETTER Z WITH ACUTE
    '\u0136'    # 0xBD -> LATIN CAPITAL LETTER K WITH CEDILLA
    '\u013c'    # 0xBE -> LATIN SMALL LETTER L WITH CEDILLA
    ...
    '\u014d'    # 0xCB -> LATIN SMALL LETTER O WITH MACRON
    '\xf6'      # 0xCC -> LATIN SMALL LETTER O WITH DIAERESIS
    '\u0146'    # 0xCD -> LATIN SMALL LETTER N WITH CEDILLA
    ...
    '\u0107'    # 0xDB -> LATIN SMALL LETTER C WITH ACUTE
    '\xfc'      # 0xDC -> LATIN SMALL LETTER U WITH DIAERESIS
    '\u0142'    # 0xDD -> LATIN SMALL LETTER L WITH STROKE
    '\u015b'    # 0xDE -> LATIN SMALL LETTER S WITH ACUTE
    '\u2019'    # 0xDF -> RIGHT SINGLE QUOTATION MARK
    ...
    '\u014c'    # 0xEB -> LATIN CAPITAL LETTER O WITH MACRON
    '\xd6'      # 0xEC -> LATIN CAPITAL LETTER O WITH DIAERESIS
    '\u0145'    # 0xED -> LATIN CAPITAL LETTER N WITH CEDILLA
    ...
    '\u0106'    # 0xFB -> LATIN CAPITAL LETTER C WITH ACUTE
    '\xdc'      # 0xFC -> LATIN CAPITAL LETTER U WITH DIAERESIS
    '\u0141'    # 0xFD -> LATIN CAPITAL LETTER L WITH STROKE
    '\u015a'    # 0xFE -> LATIN CAPITAL LETTER S WITH ACUTE
